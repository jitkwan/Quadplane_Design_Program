function[batt_i,motor_ii,esc_iiii,weight_engine,weight_batt,cell,work_hover,dia_prop] = multirotor_select(n_motor,weight_est,t_hover,work_cruise)
weight_initial = 10e6;%(g)
weight_condition = weight_initial;
batt = importdata('databatt6600mAh.txt');   %call battdata (fixed batt in lab) you can change data file 
motor = importdata('datamotor_used_hover.txt');  %call motordata (you can change data file)
...
for i=1:batt_n
    ...
    for ii = 1:motor_n
        ...
        prop_dia = motor(ii,18);    %call diameter propeller(inch)
        ...
        for iiii =  1:esc_n
            ...
            weight_engine_cal = weight_b + 4*weight_m + weight_esc;
            ...
            if weight_total < weight_condition %condition to choose the best data
               ...
               motor_ii = ii;
               esc_iiii = iiii;
               weight_engine = weight_m*4 + weight_esc;
               weight_batt = weight_b;
               cell = cell_b;
               dia_prop = prop_dia;
